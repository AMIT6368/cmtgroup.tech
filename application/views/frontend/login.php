...
<body>
   <div class="loaderactive" >
    ...
    <div class="loginpage">
    <div class="heding"><img src="<?php echo base_url();  ?>assets/frontend/img/logo.png" alt=""></div>
    <div class="inputdata">
        ...
        $.ajax({
         ...
         { 
           ...
           setTimeout(function(){
              ...
              $(".loaderactive").css("display","none");
              $(".loaderactive").removeClass("active");
              if(resultdatamess.Document_verify_status=='Pending'){
                location.href = "UDocumentVerify";
              }else{
